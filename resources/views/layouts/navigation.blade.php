            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="flex items-center gap-3">
                        <x-application-logo class="block h-9 w-9 text-emerald-600" />
                        <span class="hidden text-sm font-semibold text-gray-900 sm:block">{{ config('app.name', 'Finance App') }}</span>
                    </a>
                </div>
